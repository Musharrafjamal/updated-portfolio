  ...
  return (
    <div
      className={cn(
        ...
        size === "sm" ? "gap-2" : size === "md" ? "gap-4" : "gap-6",
        className
      )}
    >
      {socialLinks.map((social, index) => {
        // Clone the icon element with new size
              ...
              <TooltipTrigger asChild>
                <motion.a
                  ...
                  className={`relative flex items-center justify-center rounded-full overflow-hidden ${
                    size === "sm"
                      ? `h-8 ${withTitle && "w-full"}`
                      : size === "md"
                      ? `w-12 h-12 ${withTitle && "w-full"}`
                      : `w-14 h-14 ${withTitle && "w-full"}`
                  }`}
                ...
                >
                  ...
                  {/* Glossy highlight */}
                  <div
                    className="absolute w-full h-1/2 bg-white/30 rounded-t-full"
                    style={{
                      top: 0,
                      left: 0,
                  ...
                  <div className="relative z-10 text-white flex items-center justify-center gap-1">
                    {iconWithSize} {withTitle && <p className="text-xs">{social.title}</p>}
                  </div>
                </motion.a>
              </TooltipTrigger>
              <TooltipContent>
