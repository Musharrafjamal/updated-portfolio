    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: "Check out Musharraf Jamal's profile - Senior Software Engineer, Full Stack & AI Engineer, and Designer",
          ...
          <div className="flex justify-around w-full items-center gap-4">
            <div>
              ...
              <div className="mt-4 text-md">
                2+ years building scalable, AI-powered full-stack platforms
