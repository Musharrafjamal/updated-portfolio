...
import { Download, LucideIcon, Moon, Sun } from "lucide-react";
...
export function ExpandableTabs({
  ...
  return (
    <div
      ref={outsideClickRef}
      className={cn(
        "flex flex-wrap w-56 sm:w-auto items-center gap-2 rounded-2xl border bg-background p-1 shadow-sm",
        className
      )}
    >
      {tabs.map((tab, index) => {
        ...
        return (
          <motion.button
            ...
            className={cn(
              "relative z-[999] flex items-center rounded-xl px-4 py-2 text-sm font-medium transition-colors duration-300",
              selected === index
